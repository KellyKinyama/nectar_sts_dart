...
void main() {
  ...
  group('STS_531_1_0_02 CTSA10 (TransferElectricityCredit amount sweep)', () {
    ...
    test(
      'step10 (water): 01/04/2004 00:30:00, 25.6 → 44275716003808438853',
      () {
        expect(
    ...
    test(
      'step11 (water): 01/04/2004 00:35:00, 1638.3 → 18252763951429538816',
      () {
        expect(
    ...
    test(
      'step12 (water): 01/04/2004 00:40:00, 1638.4 → 27315011099256270180',
      () {
        expect(
    ...
    test(
      'step13 (water): 01/04/2004 00:45:00, 2000.0 → 63822263014624002901',
      () {
        expect(
    ...
    test(
      'step14 (water): 01/04/2004 00:50:00, 18022.3 → 09641054211308025667',
      () {
        expect(
    ...
    test(
      'step15 (water): 01/04/2004 00:55:00, 18022.4 → 44446096428101342168',
      () {
        expect(
    ...
    test(
      'step20 (gas): 01/04/2004 00:35:00, 1638.3 → 19542256788533803049',
      () {
        expect(
    ...
    test(
      'step21 (gas): 01/04/2004 00:40:00, 1638.4 → 00240351248989131846',
      () {
        expect(
    ...
    test(
      'step22 (gas): 01/04/2004 00:45:00, 2000.0 → 09767096307961035977',
      () {
        expect(
    ...
    test(
      'step23 (gas): 01/04/2004 00:50:00, 18022.3 → 48113663060937699726',
      () {
        expect(
    ...
    test(
      'step24 (gas): 01/04/2004 00:55:00, 18022.4 → 03981404420542897416',
      () {
        expect(
    ...
    test(
      'step25 (gas): 01/04/2004 01:44:00, 181862.3 → 14196243940519813244',
      () {
        expect(
    ...
    test(
      'step26 (gas): 01/04/2004 01:49:00, 181862.4 → 49902394914324621132',
      () {
        expect(
